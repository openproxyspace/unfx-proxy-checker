...
const SortSVG = ({ reverse }) =>
    reverse ? (
        <svg className="sort-svg" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 612 612">
...
export default class ResultItemsHeader extends React.PureComponent {
    ...
    sortBy = {
        ...
        extra: () => this.sortResults('extra'),
        timeout: () => this.sortResults('timeout')
    };

    render = () => {
        const { inBlacklists, captureExtraData, keepAlive, sorting } = this.props;

        return (
            <div className="result-list-header">
                <span className="count">
                    <svg className="count" xmlns="http://www.w3.org/2000/svg" version="1.1" x="0px" y="0px" viewBox="0 0 512 512">
                ...
                {inBlacklists && inBlacklists.filter(item => item.active).length > 0 ? (
                    <span className="blacklist" title="Blacklist" onClick={this.sortBy.blacklist}>
                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" x="0px" y="0px" viewBox="0 0 511.269 511.269">
                ...
                {keepAlive ? (
                    <span className="main k-a" title="Keep-Alive" onClick={this.sortBy.keepAlive}>
                        <svg className="k-a-svg" xmlns="http://www.w3.org/2000/svg" version="1.1" x="0px" y="0px" viewBox="0 0 58 58">
                ...
                {captureExtraData && (
                    <span className="main extra" onClick={this.sortBy.extra}>
                        <span>Extra</span>
                        <SortSVG {...sorting} />
                    </span>
                )}
